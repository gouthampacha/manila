...
class ShareReplicasApiTest(test.TestCase):
    ...
    def test_create_has_been_encrypted(self):
        share_ref = fake_share.fake_share()
        share_instance_ref = fake_share.fake_share_instance(
        ...
        self.mock_object(share_replicas.db, 'share_get',
                         mock.Mock(return_value=share_ref))
        self.mock_object(share_replicas.db, 'share_instance_get',
                         mock.Mock(return_value=share_instance_ref))
