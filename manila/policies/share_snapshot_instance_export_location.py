...
deprecated_update_snapshot_instance_export_location_metadata = (
...
deprecated_delete_snapshot_instance_export_location_metadata = (
    policy.DeprecatedRule(
...
deprecated_get_snapshot_instance_export_location_metadata = (
    policy.DeprecatedRule(
