...
deprecated_update_share_group_metadata = policy.DeprecatedRule(
    name=BASE_POLICY_NAME % 'update_metadata',
    check_str=base.RULE_DEFAULT,
    deprecated_reason=DEPRECATED_REASON,
    deprecated_since=versionutils.deprecated.WALLABY
)
deprecated_delete_share_group_metadata = policy.DeprecatedRule(
    name=BASE_POLICY_NAME % 'delete_metadata',
    check_str=base.RULE_DEFAULT,
    deprecated_reason=DEPRECATED_REASON,
    deprecated_since=versionutils.deprecated.WALLABY
)
deprecated_get_share_group_metadata = policy.DeprecatedRule(
...
share_group_policies = [
    ...
    policy.DocumentedRuleDefault(
        ...
        check_str=base.SYSTEM_ADMIN_OR_PROJECT_MEMBER,
        scope_types=['system', 'project'],
        description=("Update share group metadata."),
        operations=[
            {
                'method': 'PUT',
                'path': '/share-groups/{share_group_id}/metadata',
            },
            {
                'method': 'POST',
                'path': '/share-groups/{share_group_id}/metadata',
        ...
        deprecated_rule=deprecated_update_share_group_metadata
    ),
    policy.DocumentedRuleDefault(
        name=BASE_POLICY_NAME % 'delete_metadata',
        check_str=base.SYSTEM_ADMIN_OR_PROJECT_MEMBER,
        scope_types=['system', 'project'],
        description=("Delete share group metadata."),
        operations=[
            {
                'method': 'DELETE',
                'path': '/share-groups/{share_group_id}/metadata/{key}',
            }
        ],
        deprecated_rule=deprecated_delete_share_group_metadata
    ),
    policy.DocumentedRuleDefault(
        name=BASE_POLICY_NAME % 'get_metadata',
        check_str=base.SYSTEM_OR_PROJECT_READER,
        scope_types=['system', 'project'],
        description=("Get share group metadata."),
        operations=[
            {
                'method': 'GET',
                'path': '/share-groups/{share_group_id}/metadata',
        ...
        deprecated_rule=deprecated_get_share_group_metadata
    ),
]
